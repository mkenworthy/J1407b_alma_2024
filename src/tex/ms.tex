...
We report on ALMA Band 7 continuum observations towards the star J1407 taken in mid 2024.
%
We do not detect the source seen in the previous ALMA Band 7 observations in 2017, and place upper limits on a source at the proper motion corrected expected location in this 2024 data.
...
%
Followup ALMA observations were undertaken to determine whether the dust emission from the \textit{eclipsing?} object could be detected in Band 7 (345 GHz) continuum emission. With an rms noise level of 18.6$\mu$Jy, an unresolved source was seen in the ALMA data \citep{Kenworthy20} with a peak flux of 79$\mu$Jy, spatially offset from the position expected for J1407 given its proper motion, suggesting a chance transit. That detection combined with the original epoch data suggested that the ALMA detected object would have moved sufficiently to be detectable at a new, spatially separate, position in 2024.
...
This suggests that the original detection was likely a noise spike, or some form of time varying or dimming object. Had it been a background extragalactic source, it should have remained detectable at the $\sim4\sigma$ level at the same position as the 2017 observation. 
